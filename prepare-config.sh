...
if [ -e "/terraria-server/Worlds/$TMOD_WORLDNAME.wld" ]; then
    echo "world=/terraria-server/Worlds/$TMOD_WORLDNAME.wld" >> "$configPath"
    echo "worldpath=/terraria-server/Worlds/" >> "$configPath"
else
